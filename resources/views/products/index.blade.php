		...
		<div class="row">
	        <div class="col-md-6">
	           <div class="container" style="width: 400px; margin: 0 auto">
				  <div id="productPhotosCarousel" class="carousel slide">
				    <!-- Indicators -->
				    <ol class="carousel-indicators">
				      <li data-target="#productPhotosCarousel" data-slide-to="0" class="active"></li>
				      <li data-target="#productPhotosCarousel" data-slide-to="1"></li>
				      <li data-target="#productPhotosCarousel" data-slide-to="2"></li>
				    </ol>
				    ...
				    <div class="carousel-inner" role="listbox">
				      @foreach ($product->productPhotos as $index => $photo)
                        <div class="item @if ($index==0) {!! 'active' !!} @endif">
				        	<img src="{!! route('user.products.photos.getphoto', $photo->id) !!}" alt="ALT NAME" class="img-responsive" style="margin: 0 auto"/>
				      	</div>
				      @endforeach
				    </div>

				    <!-- Left and right controls -->
				    <a class="left carousel-control" href="#productPhotosCarousel" role="button" data-slide="prev">
				      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
				      <span class="sr-only">Previous</span>
				    </a>
				    <a class="right carousel-control" href="#productPhotosCarousel" role="button" data-slide="next">
	        ...
	        <div class="col-md-3">
	        	<div class="caption">
	                 ...
	                 <ul class="list-unstyled">
	                    <li>{!! link_to_route('user.products.edit' , 'Edit' , [$user->id, $product->id] , ['class'=>'tiny alert button', 'class'=>'form-control'])!!}</li>
						<li>
							{!! Form::model($product, ['route'=> ['user.products.destroy', $user->id, $product->id], 'method' => 'DELETE']) !!}
								{!! Form::button('Delete', ['type'=>'submit', 'class'=>'tiny alert button', 'class'=>'form-control'])!!}
							{!! Form::close() !!}
						</li>
	                 </ul>
	            </div>
